...
<body>
  ...
  <!-- <div class="d-flex align-items-center justify-content-center vh-100 ">
    <div class="text-center">
      <img src="assets/dist/img/verCurso.jpg" class="img-fluid" alt="">
    </div>
  </div> -->
  ...
  <div class="row justify-content-md-center">
    ...
    <div class="col-md-7">
      ...
      <div class="card">
        <div class="text-center">
          <img src="assets/dist/img/verCurso.jpg" class="card-img-top" style="width: 18rem;">
        </div>
        <div class="card-body text-center">
          <h5 class="h2">¡Visualice su curso!</h5>
          <p class="card-text">Desde <b>TODO-CURSO</b> esperamos este disfrutando su curso y aprovechando al máximo su inversión.</p>
